...
if($islogin){
            ...
            <a href="../../index.php"><div class="icons "><i class="fa fa-globe fa-3x" aria-hidden="true"></i></div></a>
            <a href="index.php"><div class="icons active "><i class="fa fa-television fa-3x " aria-hidden="true"></i>    </div></a> 
            <div class="icons "><i class="fa fa-graduation-cap fa-3x" aria-hidden="true"></i></div> 
            ...
            <a href="index.phpp"><div class="icons active "><i class="fa fa-television fa-3x " aria-hidden="true"></i>    </div></a> 
            <div class="icons "><i class="fa  fa-graduation-cap fa-3x" aria-hidden="true"></i></div>
