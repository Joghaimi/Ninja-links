<?php
    $stmt='SELECT * FROM power_sec WHERE 1';
    $param=[];
    ...
    if($querys){
       ...
       foreach($querys as $key =>$val){
        $i++;
        if($i%2==0){
             echo "<a href='power_links.php?power_id=".$querys[$key]['id']."'>
             <div class='post-blue post-sec'>";
        }else{
             echo "<a href='power_links.php?power_id=".$querys[$key]['id']."'><div class='post-red post-sec'>";            
        }
