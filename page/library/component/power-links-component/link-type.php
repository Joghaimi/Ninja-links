<div class='col-lg-12'>
    <div class="col-lg-4 visible-lg  hidden-md hidden-sm no_margin_btm">
        ...
        onclick=print_links_using_type(<?php echo $link_to_print .',' ."1".','.'2';?>)
        
        >
            <i class="fa  fa-video-camera   icon-si" aria-hidden="true"></i>
        </div>   
        
        <div class="col-lg-3 blue" style="text-align:center"
        onclick="print_links_using_type(<?php echo $link_to_print .',' ."1".','.'3';?>)";
