...
include_once "component/control/function.php";

include_once "component/control/header.php";
require_once '../../include/part/side_bar/side_bar_lib.php';?>
  <!-- the new start -->
...
?>
    <!-- the new end -->
            ...
            <?php include_once "../../include/class/lib/print_control_section.php";?>
        </div>
