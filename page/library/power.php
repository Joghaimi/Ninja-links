...
include_once "component/power-component/function.php";
include_once "component/power-component/header.php";
...
?>
    <!-- the new end -->
        ...
        <?php include_once "../../include/class/lib/print_power_section.php";?>
        </div>
